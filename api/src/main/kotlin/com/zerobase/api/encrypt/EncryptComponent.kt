...
class EncryptComponent {
    ...
    fun cipherPkcs5(opMode: Int, secretKey: String): Cipher {
        ...
        val sk = SecretKeySpec(Companion.secretKey.toByteArray(Charsets.UTF_8), "AES")
        val iv = IvParameterSpec(Companion.secretKey.substring(0, 16).toByteArray(Charsets.UTF_8))
        c.init(opMode, sk, iv)
        return c
    }
}